...
const FAQPage = () => {
    ...
    const faqs = [
        {
            question: '1. What is Plantorium?',
            answer: "Plantorium is an online platform designed to help you discover and purchase plants for your home or garden. We offer a variety of plants from nurseries around the country, with features to help users, nurseries, and admins manage their plant collections, orders, and profiles.",
        },
        {
            question: "2. How can I create an account on Plantorium?",
            answer: (
                <>
                    <p>To create an account on Plantorium:</p>
                    <ol>
            ...
            answer: (
                <>
                    ...
                    <ol>
                        ...
                        <li>You can send us a message through the contact form or email us directly at <a href="mailto:divyanshusolanki7@gmail.com">divyanshusolanki7@gmail.com</a>.</li>
                    </ol>
                </>
            )
        },
        {
            question: '13. How can I become an admin on Plantorium?',
            answer: (
                <>
                    <p>Admins are usually invited by the platform owner. If you're interested in becoming an admin, please contact us at <a href="mailto:divyanshusolanki7@gmail.com">divyanshusolanki7@gmail.com   </a>.</p>
        ...
        {
            question: '17. Is there a mobile app available for Plantorium?',
            answer: "Currently, Plantorium is a web-based platform and does not have a dedicated mobile app. However, the website is fully responsive and optimized for use on mobile devices."
        },
        {
            question: '18. Can I subscribe to newsletters from Plantorium?',
        ...
        {
            question: '19. Is my personal information safe on Plantorium?',

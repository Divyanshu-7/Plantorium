        ...
        <section className="bg-light py-5">
            <div className="container py-4 px-3 rounded bg-white">
                <header className="mb-5">
                    <h1 className="display-4 text-center">Help - Plantorium</h1>
                    <p className="lead text-center">
                        Your go-to guide for navigating Plantorium. Find answers to common
                ...
                <section id="getting-started" className="section-title">
                    ...
                    <p>
                        <strong>What is Plantorium?</strong>
                        <br />
                        Plantorium is your go-to online store for buying a wide range of
                ...
                <section id="contact-us" className="section-title">
                    ...
                    <p>
                        <strong>Email:</strong>{" "}
                        <Link to="mailto:divyanshusolanki7@gmail.com">divyanshusolanki7@gmail.com</Link>
                    </p>
                    <p>

                        <strong>Phone:</strong>
                        <Link to="tel:+918103515143"> +91 8103515143</Link>
                    </p>
                    <p>
                        <strong>Address:</strong> Potheri, Chennai, India.
                    </p>
                </section>

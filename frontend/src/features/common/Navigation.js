...
const Navigation = () => {
    ...
    return (
        <nav className="navbar navbar-expand-md navbar-dark bg-dark fixed-top w-100 py-0">
            <div className="container-fluid">
                <Link className="navbar-brand ms-5" to="/"><img src={logoImg} alt="plantorium logo" className='logo-img' style={{ maxWidth: '150px', height: 'auto', objectFit: 'contain' }} /></Link>
